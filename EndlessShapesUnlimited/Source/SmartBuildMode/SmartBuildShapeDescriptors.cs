...
namespace DecoLimitLifter.SmartBuildMode
{
    ...
    internal static class SmartBuildShapeDescriptors
    {
        ...
        {
            CuboidDescriptor,
            Descriptor(DownSlopeKey, SmartBuildShapeKind.DownSlope, SmartBuildShapeCategory.Slopes, "Down slope", "Place 1m to 4m down-slope ramp segments.", true, proceduralDownSlope: true),
            Descriptor("pole", SmartBuildShapeKind.Pole, SmartBuildShapeCategory.Basic, "Pole", "Place 1m to 4m rounded pole beams.", true),
            Descriptor("facing-down-slope-left", SmartBuildShapeKind.FacingDownSlope, SmartBuildShapeCategory.Slopes, "Facing slope L", "Place left-handed diagonal beam-slope blocks.", true, handedness: SmartBuildShapeHandedness.Left, mirrorKey: "facing-down-slope-right"),
            Descriptor("facing-down-slope-right", SmartBuildShapeKind.FacingDownSlope, SmartBuildShapeCategory.Slopes, "Facing slope R", "Place right-handed diagonal beam-slope blocks.", true, handedness: SmartBuildShapeHandedness.Right, mirrorKey: "facing-down-slope-left"),
            ...
            Descriptor("square-backed-corner-left", SmartBuildShapeKind.SquareBackedCorner, SmartBuildShapeCategory.Corners, "Backed square L", "Place left-handed square-backed corner blocks.", true, handedness: SmartBuildShapeHandedness.Left, mirrorKey: "square-backed-corner-right"),
            Descriptor("square-backed-corner-right", SmartBuildShapeKind.SquareBackedCorner, SmartBuildShapeCategory.Corners, "Backed square R", "Place right-handed square-backed corner blocks.", true, handedness: SmartBuildShapeHandedness.Right, mirrorKey: "square-backed-corner-left"),
            ...
            Descriptor("inverted-triangle-corner-left", SmartBuildShapeKind.InvertedTriangleCorner, SmartBuildShapeCategory.Corners, "Inverted corner L", "Place left-handed inverted triangle corner blocks.", true, handedness: SmartBuildShapeHandedness.Left, mirrorKey: "inverted-triangle-corner-right"),
            Descriptor("inverted-triangle-corner-right", SmartBuildShapeKind.InvertedTriangleCorner, SmartBuildShapeCategory.Corners, "Inverted corner R", "Place right-handed inverted triangle corner blocks.", true, handedness: SmartBuildShapeHandedness.Right, mirrorKey: "inverted-triangle-corner-left"),
